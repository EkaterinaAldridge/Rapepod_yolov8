...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, producer=None):
        """
        ...
        self.trainset, self.testset = self.get_dataset(self.data)   # /codes/datasets/coco128-seg/images/train2017
        self.ema = None
    ...
    def _do_train(self, rank=-1, world_size=1):
        ...
        if rank in {-1, 0}:
            ...
            if self.args.plots:
                self.plot_metrics()
            self.metrics['metrics/precision(M)']  # MASK-P
            self.metrics['metrics/recall(M)']     # MASK-R
            self.metrics['metrics/mAP50(M)']      # MASK-mAP50
